...
import { ActivitySkeleton, KanbanCardSkeleton } from "@/components/shared/Skeletons";
import {
  Dialog,
  DialogContent,
  DialogDescription,
      ...
      <div className="space-y-6 animate-pulse">
        ...
        <div className="flex justify-between items-start">
          <div className="space-y-3 flex-1">
            <div className="h-9 w-1/3 bg-muted/80 rounded-lg" />
            <div className="h-4 w-2/3 bg-muted/60 rounded-md" />
            <div className="h-3 w-1/4 bg-muted/40 rounded-md" />
          </div>
          <div className="flex gap-2">
            <div className="h-9 w-16 bg-muted/60 rounded-md" />
            <div className="h-9 w-20 bg-muted/60 rounded-md" />
          </div>
        </div>

        {/* Progress Card Skeleton */}
        <div className="h-20 bg-muted/40 border border-border/20 rounded-xl p-4 space-y-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-4 pt-2">
              <div className="h-4 w-32 bg-muted/60 rounded mb-2" />
          ...
          <div className="space-y-4">
            ...
            <div className="h-48 bg-muted/30 border border-border/10 rounded-xl p-4">
